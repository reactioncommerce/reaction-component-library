...
test("custom cart empty button", () => {
  const onClick = () => {};
  const component = renderer.create(<CartEmptyMessage buttonText={"Custom button text"} components={{ContinueShoppingButton: Button}} messageText={"Custom message text"} onClick={onClick} />);
